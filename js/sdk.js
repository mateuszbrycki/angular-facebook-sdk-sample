/*1491938601,,JIT Construction: v2950535,en_US*/
...
try {
        ...
        (function () {
            ...
            with (this) {
                    ...
                    (function () {
                        ...
                        if (!n || !s) {
                            if (!(i = {}.hasOwnProperty))i = function (ga) {
                                var ha = {}, ia;
                                if ((ha.__proto__ = null, ha.__proto__ = {toString: 1}, ha).toString != h) {
                                    i = function (ja) {
                            ...
                            j = function (ga, ha) {
                                ...
                                if (!ia) {
                                    ...
                                    ma = function (na, oa) {
                                        var pa = h.call(na) == "[object Function]", qa, ra;
                                        for (qa in na)if (!(pa && qa == "prototype") && i.call(na, qa))oa(qa);
                                        for (ra = ka.length; qa = ka[--ra]; i.call(na, qa) && oa(qa));
                                    };
                                } else if (ia == 2) {
                                    ma = function (na, oa) {
                                        var pa = {}, qa = h.call(na) == "[object Function]", ra;
                                        for (ra in na)if (!(qa && ra == "prototype") && !i.call(pa, ra) && (pa[ra] = 1) && i.call(na, ra))oa(ra);
                                    };
                                } else ma = function (na, oa) {
                                    var pa = h.call(na) == "[object Function]", qa, ra;
                                    for (qa in na)if (!(pa && qa == "prototype") && i.call(na, qa) && !(ra = qa === "constructor"))oa(qa);
                            ...
                            if (!n) {
                                ...
                                l.stringify = function (ga, ha, ia) {
                                    ...
                                    if (typeof ha == "function" || typeof ha == "object" && ha)if (h.call(ha) == "[object Function]") {
                                        ka = ha;
                                    ...
                                    if (ia)if (h.call(ia) == "[object Number]") {
                            ...
                            if (!s) {
                                ...
                                w = function () {
                                    var ga = ba, ha = ga.length, ia, ja, ka, la, ma;
                                    while (aa < ha) {
                                        ia = ga.charAt(aa);
                                        if ("\t\r\n ".indexOf(ia) > -1) {
                                            aa++;
                                ...
                                y = function (ga, ha, ia) {
                                    var ja = ga[ha], ka;
                                    if (typeof ja == "object" && ja)if (h.call(ja) == "[object Array]") {
                ...
                __d('ES', ['ES5ArrayPrototype', 'ES5FunctionPrototype', 'ES5StringPrototype', 'ES5Array', 'ES5Object', 'ES5Date', 'JSON3', 'ES6Array', 'ES6Object', 'ES6ArrayPrototype', 'ES6DatePrototype', 'ES6Number', 'ES7StringPrototype', 'ES7Object'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u) {
                    ...
                    function aa(ca) {
                        for (var da in ca) {
                            if (!Object.prototype.hasOwnProperty.call(ca, da))continue;
                            ...
                            for (var la in ea) {
                                if (!Object.prototype.hasOwnProperty.call(ea, la))continue;
                ...
                __d("JSSDKRuntimeConfig", [], {"locale": "en_US", "rtl": false, "revision": "2950535"});
                __d("JSSDKConfig", [], {
                    "bustCache": true,
                ...
                __d("JSSDKXDConfig", [], {
                    ...
                    "XdBundleUrl": "\/connect\/xd_arbiter\/r\/iKWhU6BAGf7.js?version=42",
                ...
                __d('insertIframe', ['GlobalCallback', 'getBlankIframeSrc', 'guid'], (function a(b, c, d, e, f, g, h, i, j) {
                    function k(l) {
                        l.id = l.id || j();
                        l.name = l.name || j();
                        var m = false, n = false, o = function s() {
                            if (m && !n) {
                                n = true;
                ...
                __d('sdk.Content', ['Log', 'sdk.UA', 'sdk.domReady'], (function a(b, c, d, e, f, g, h, i, j) {
                    var k, l, m = {
                        append: function n(o, p) {
                            ...
                            if (!p) {
                                var p = document.createElement('div'), q = p.style;
                                q.position = 'absolute';
                                q.top = '-10000px';
                                q.width = q.height = 0;
                                p = m.append(p);
                ...
                __d('URISchemes', ['createObjectFrom'], (function a(b, c, d, e, f, g, h) {
                    var i = h(['blob', 'cmms', 'fb', 'fbatwork', 'fb-ama', 'fb-messenger', 'fb-page-messages', 'fb-pma', 'fbcf', 'fbconnect', 'fbmobilehome', 'fbrpc', 'file', 'ftp', 'http', 'https', 'mailto', 'ms-app', 'intent', 'itms', 'itms-apps', 'itms-services', 'market', 'svn+ssh', 'fbstaging', 'tel', 'sms', 'pebblejs', 'sftp', 'whatsapp', 'moments', 'fblite', 'chrome-extension', 'webcal', 'fb124024574287414', 'fb124024574287414rc', 'fb124024574287414master', 'fb1576585912599779', 'fb929757330408142', 'designpack', 'fbapi20130214']), j = {
                ...
                __d('URIBase', ['URIRFC3986', 'URISchemes', 'ex', 'invariant', 'setHostSubdomain'], (function a(b, c, d, e, f, g, h, i, j, k, l) {
                    var m = new RegExp('[\\x00-\\x2c\\x2f\\x3b-\\x40\\x5c\\x5e\\x60\\x7b-\\x7f' + '\\uFDD0-\\uFDEF\\uFFF0-\\uFFFF' + '\\u2047\\u2048\\uFE56\\uFE5F\\uFF03\\uFF0F\\uFF1F]'), n = new RegExp('^(?:[^/]*:|' + '[\\x00-\\x1f]*/[\\x00-\\x1f]*/)');
                ...
                __d('Flash', ['DOMEventListener', 'DOMWrapper', 'QueryString', 'UserAgent_DEPRECATED', 'guid', 'htmlSpecialChars'], (function a(b, c, d, e, f, g, h, i, j, k, l, m) {
                    ...
                    var u = {
                        embed: function v(w, x, y, z) {
                            ...
                            var ba = [];
                            for (var ca in y)if (Object.prototype.hasOwnProperty.call(y, ca) && y[ca])ba.push('<param name="' + m(ca) + '" value="' + m(y[ca]) + '">');
                            var da = x.appendChild(p.createElement('span')), ea = '<object ' + (k.ie() ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ' : 'type="application/x-shockwave-flash"') + 'data="' + w + '" ' + (y.height ? 'height="' + y.height + '" ' : '') + (y.width ? 'width="' + y.width + '" ' : '') + 'id="' + aa + '">' + ba.join('') + '</object>';
                            da.innerHTML = ea;
                    ...
                    u.register('flash', function () {
                        ...
                        return {
                            isAvailable: function ba() {
                                ...
                                var ea = ca.root.appendChild(s.document.createElement('div')), fa = l.create(function () {
                                    l.remove(fa);
                                    clearTimeout(aa);
                        ...
                        return {
                            isAvailable: function x() {
                                ...
                                h.add(s, 'message', p(function (event) {
                                    var ba = event.data, ca = event.origin || 'native';
                ...
                __d('sdk.createIframe', ['DOMEventListener', 'getBlankIframeSrc', 'guid', 'hasNamePropertyBug', 'isNumberLike'], (function a(b, c, d, e, f, g, h, i, j, k, l) {
                    function m(n) {
                        ...
                        var o, p = n.name || j(), q = n.root, r = n.style || {border: 'none'}, s = n.url, t = n.onload, u = n.onerror;
                        if (k()) {
                    ...
                    function ta(va) {
                        ...
                        var wa = h.appendHidden(document.createElement('div')), xa = s.create({
                            ...
                            whenReady: function ya(za) {
                                ka = za;
                                var ab = {channel: ia, origin: ja, transport: xa, xd_name: va}, bb = '#' + k.encode(ab);
                    ...
                    i.subscribe('init:post', function (va) {
                        ...
                        if (wa)setTimeout(function () {
                            ...
                            if (!xa)o.log('jssdk_error', {
                                ...
                                extra: {message: 'Failed to initialize in ' + wa + 'ms'}
                            });
                        }, wa);
                    });
                    f.exports = ua;
                    ...
                    function da(ja, ka, la) {
                        return function (ma) {
                            ...
                            if (ma && ma.access_token) {
                                ...
                                if (q.getUseCookie()) {
                                    var pa = ka.expiresIn === 0 ? 0 : ES('Date', 'now', false) + ka.expiresIn * 1000, qa = h.getDomain();
                    ...
                    function q(v, w) {
                        return function () {
                            ...
                            try {
                                ...
                                if (z instanceof h)throw z;
                                var x = l(z);
                                x.entry = w;
                                var y = ES(Array.prototype.slice.call(arguments), 'map', true, function (aa) {
                ...
                __d('CORSRequest', ['wrapFunction', 'QueryString', 'errorCode', 'sdk.safelyParseResponse'], (function a(b, c, d, e, f, g, h, i, j, k) {
                    function l(o, p) {
                        ...
                        var q = new XMLHttpRequest(), r = function v() {
                        };
                        ...
                        q.onreadystatechange = function () {
                            if (q.readyState == 4)if (q.status == 200) {
                                t();
                            } else u();
                        };
                        return s;
                ...
                __d('ApiClient', ['ArgumentError', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'sprintf', 'sdk.URI', 'UrlMap', 'ApiClientConfig', 'invariant', 'sdk.safelyParseResponse'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
                    ...
                    function la(va, wa, xa, ya) {
                        ...
                        xa = l(xa);
                        var ab = {jsonp: m, cors: j, flash: k}, bb = {}, cb = xa.access_token || w;
                        ...
                        for (var fb = 0; fb < eb.length; fb++) {
                            var gb = ab[eb[fb]], hb = ES('Object', 'assign', false, {}, xa);
                    ...
                    function na(va) {
                        ...
                        try {
                            ...
                            throw new h(cb.message, cb);
                        }
                        ES(va, 'forEach', true, function (cb) {
                            return ya[typeof cb] = cb;
                        });
                        var za = (ya.string || 'get').toLowerCase();
                        i.isTrue(Object.prototype.hasOwnProperty.call(aa, za), q('Invalid method passed to ApiClient: %s', za));
                        var ab = ya['function'];
                        if (!ab)n.warn('No callback passed to the ApiClient');
                        if (ya.object)xa.addQueryData(l(ya.object));
                        var bb = xa.getQueryData();
                        bb.method = za;
                        return {uri: xa, callback: ab, params: bb};
                    }

                    function oa() {
                        for (var va = arguments.length, wa = Array(va), xa = 0; xa < va; xa++)wa[xa] = arguments[xa];
                        var ya = na(wa), za = ya.uri, ab = ya.callback, bb = ya.params, cb = bb.method;
                        if (ua(za, cb))cb = 'post';
                    ...
                    function qa() {
                        for (var va = arguments.length, wa = Array(va), xa = 0; xa < va; xa++)wa[xa] = arguments[xa];
                        var ya = pa(wa), za = ya.body, ab = ya.callback, bb = ya.method, cb = ya.relative_url, db = {
                            method: bb,
                            relative_url: cb
                        };
                        if (za)db.body = za;
                    ...
                    function ra() {
                        ...
                        fa = null;
                        if (va.length === 1) {
                            var xa = va[0], ya = wa[0], za = xa.body ? p.decode(xa.body) : null;
                    ...
                    function sa(va, wa) {
                        ...
                        va.api_key = x;
                        var ya = xa in ba ? 'api_read' : 'api', za = s.resolve(ya) + '/restserver.php', ab = ES(ma, 'bind', true, null, wa, '/restserver.php', 'get', va, ES('Date', 'now', false));
                        la(za, 'get', va, ab);
                    }
                    ...
                    var ta = ES('Object', 'assign', false, new o(), {
                        setAccessToken: function va(wa) {
                            ...
                            return ha.length;
                        }, rest: sa, graph: oa, scheduleBatchCall: qa, prepareBatchParams: pa
                    });
                ...
                __d('sdk.DialogUtils', ['sdk.Content', 'sdk.DOM', 'DOMEventListener', 'sdk.UA', 'sdk.feature'], (function a(b, c, d, e, f, g, h, i, j, k, l) {
                    ...
                    var m = {
                        isOrientationPotrait: function n() {
                            ...
                            var r = void 0, event = void 0, s = function t() {
                                r = setTimeout(p, q);
                            };
                            s();
                            ...
                            var event = 'onorientationchange' in window ? 'orientationchange' : 'resize', p = function q(r) {
                            ...
                            }, s = i.getViewportInfo(), t = r(o.offsetWidth), u = r(o.offsetHeight), v = s.scrollLeft + (s.width - t) / 2, w = (s.height - u) / 2.5;
                            if (v < w)w = v;
                ...
                __d('sdk.Dialog', ['sdk.Canvas.Environment', 'sdk.Content', 'sdk.DialogUtils', 'sdk.DOM', 'DOMEventListener', 'ObservableMixin', 'sdk.Runtime', 'Type', 'sdk.UA', 'sdk.fbt', 'sdk.feature'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r) {
                    ...
                    var y = o.extend({
                        constructor: function aa(ba, ca) {
                            ...
                            for (var ca in ba)if (Object.prototype.hasOwnProperty.call(ba, ca))this.trackEvent(ca, ba[ca]);
                            return this;
                        }
                    }, m), z = {
                        ...
                        _createMobileLoader: function aa() {
                            ...
                            return z.create({classes: 'loading' + (z.isTabletStyle() ? ' centered' : ''), content: ba});
                        },
                        ...
                        _setDialogSizes: function aa() {
                            ...
                            if (!p.mobile())return;
                            for (var ca in z._dialogs)if (Object.prototype.hasOwnProperty.call(z._dialogs, ca)) {
                        ...
                        getDefaultSize: function aa() {
                            if (p.mobile()) {
                                ...
                                if (p.android()) {
                                    ...
                                    var ca = window.innerWidth, da = window.innerHeight, ea = ca / da > 1.2;
                        ...
                        _handleOrientationChange: function aa() {
                            ...
                            if (z.isTabletStyle()) {
                                ...
                                for (var da in z._dialogs)if (Object.prototype.hasOwnProperty.call(z._dialogs, da)) {
                ...
                __d('sdk.openMessenger', ['sdk.UA'], (function a(b, c, d, e, f, g, h) {
                    'use strict';
                    var i = 'https://itunes.apple.com/us/app/messenger/id454638411', j = 'https://play.google.com/store/apps/details?id=com.facebook.orca', k = 3000;
                ...
                __d('sdk.UIServer', ['sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Dialog', 'sdk.Event', 'sdk.Frictionless', 'Log', 'sdk.Native', 'QueryString', 'sdk.RPC', 'sdk.Runtime', 'JSSDKConfig', 'sdk.UA', 'UrlMap', 'sdk.XD', 'createObjectFrom', 'sdk.feature', 'sdk.fbt', 'flattenObject', 'sdk.getContextType', 'guid', 'insertIframe', 'sdk.openMessenger', 'resolveURI'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba, ca, da, ea) {
                    var fa = {
                        ...
                        'auth.logout': {
                            url: 'logout.php', transform: function la(ma) {
                                if (!r.getClientID()) {
                        ...
                        'login.status': {
                            url: 'dialog/oauth', transform: function la(ma) {
                                var na = ma.cb, oa = ma.id;
                                delete ma.cb;
                                ES('Object', 'assign', false, ma.params, {
                                    client_id: r.getClientID(),
                    ...
                    var ka = {
                        ...
                        checkOauthDisplay: function la(ma) {
                            ...
                            var oa = na.split(/\s|,/g);
                            for (var pa = 0; pa < oa.length; pa++)if (!s.initSitevars.iframePermissions[ES(oa[pa], 'trim', true)])return 'popup';
                            return ma.display;
                        },
                        prepareCall: function la(ma, na) {
                            var oa = ma.method.toLowerCase(), pa = Object.prototype.hasOwnProperty.call(ka.Methods, oa) ? ES('Object', 'assign', false, {}, ka.Methods[oa]) : {}, qa = ba(), ra = r.getSecure() || oa !== 'auth.status' && oa != 'login.status';
                            ...
                            var va = pa.getXdRelation || ka.getXdRelation, wa = va(ta.params);
                        ...
                        getDisplayMode: function la(ma, na) {
                            ...
                            if (na.display == 'iframe' || na.display == 'dialog')if (!ka.canIframe(na)) {
                        ...
                        popup: function la(ma) {
                            ...
                            if (ma.post) {
                                ...
                                if (xa) {
                                    ...
                                    i.submitToTarget({url: ma.url, target: ma.id, params: ma.params});
                                }
                            } else {
                        ...
                        getLoadedNode: function la(ma) {
                            var na = typeof ma == 'object' ? ma.id : ma, oa = ka._loadedNodes[na];
                            ...
                            if (ma.post) {
                                ca({
                                    ...
                                    onload: function oa(pa) {
                                        i.submitToTarget({url: ma.url, target: pa.name, params: ma.params});
                                    }
                                });
                            } else ca({
                                url: ma.url,
                        ...
                        _popupMonitor: function la() {
                            var ma;
                            for (var na in ka._loadedNodes)if (Object.prototype.hasOwnProperty.call(ka._loadedNodes, na) && na in ka._defaultCb) {
                ...
                __d('legacy:fb.compat.ui', ['FB', 'Log', 'sdk.ui', 'sdk.UIServer'], (function a(b, c, d, e, f, g, h, i, j, k) {
                    h.provide('', {
                        share: function l(m) {
                            ...
                            j({display: 'popup', method: 'stream.share', u: m});
                            ...
                            j({display: 'popup', id: m, method: 'friend.add'}, n);
                        }
                    });
                ...
                __d('sdk.Query', ['format', 'safeEval', 'Type', 'sdk.Waitable'], (function a(b, c, d, e, f, g, h, i, j, k) {
                    ...
                    function m(q) {
                        var r = /^\s*(\w+)\s*=\s*(.*)\s*$/i.exec(q), s, t, u = 'unknown';
                        if (r) {
                            t = r[2];
                            if (/^(["'])(?:\\?.)*?\1$/.test(t)) {
                                t = i(t);
                        ...
                        if (u == 'index') {
                            s = {type: 'index', key: r[1], value: t};
                        } else s = {type: 'unknown', value: q};
                        return s;
                    }
                    ...
                    var o = 1, p = k.extend({
                        constructor: function q() {
                            ...
                            var s = h.apply(null, r), t = /^select (.*?) from (\w+)\s+where (.*)$/i.exec(s);
                            this.fields = l(t[1]);
                            this.table = t[2];
                            this.where = m(t[3]);
                            for (var u = 1; u < r.length; u++)if (j.instanceOf(p, r[u]))r[u].hasDependency(true);
                            return this;
                        }, toFql: function q() {
                            ...
                            switch (this.where.type) {
                                ...
                                case 'in':
                                    if (this.where.value.length == 1) {
                                        r += this.where.key + '=' + n(this.where.value[0]);
                ...
                __d('sdk.Data', ['sdk.api', 'sdk.ErrorHandling', 'mergeArrays', 'sdk.Query', 'safeEval', 'sdk.Waitable'], (function a(b, c, d, e, f, g, h, i, j, k, l, m) {
                    var n = {
                        query: function o(p, q) {
                            var r = new k().parse(Array.prototype.slice.call(arguments));
                            n.queue.push(r);
                            n._waitToProcess();
                            return r;
                        }, waitOn: function o(p, q) {
                            var r = new m(), s = p.length;
                            if (typeof q == 'string') {
                                var t = q;
                            ...
                            t.fields = p;
                            t.table = q;
                            t.where = {type: 'index', key: r, value: s};
                            n.queue.push(t);
                            n._waitToProcess();
                            return t;
                            ...
                            for (var s = 0; s < r.length; s++) {
                                var t = r[s];
                                if (t.where.type == 'index' && !t.hasDependency()) {
                                    n._mergeIndexQuery(t, q);
                                } else q[t.name] = t;
                            }
                            var u = {q: {}};
                            for (var v in q)if (Object.prototype.hasOwnProperty.call(q, v))u.q[v] = q[v].toFql();
                            if (p)u.access_token = p;
                            h('/fql', 'GET', u, function (w) {
                                if (w.error) {
                                    ES(ES('Object', 'keys', false, q), 'forEach', true, function (x) {
                                        q[x].error(new Error(w.error.message));
                                    });
                            ...
                            var r = p.where.key, s = p.where.value, t = 'index_' + p.table + '_' + r, u = q[t];
                            if (!u) {
                                u = q[t] = new k();
                                u.fields = [r];
                                u.table = p.table;
                                u.where = {type: 'in', key: r, value: []};
                            }
                            j(u.fields, p.fields);
                            j(u.where.value, [s]);
                            u.wait(function (v) {
                ...
                __d('sdk.MBasicInitializer', ['sdk.DOM', 'sdk.Runtime', 'sdk.UA', 'sdk.URI', 'UrlMap', 'sdk.fbt', 'sdk.feature'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n) {
                    var o = function q() {
                        function r(s) {
                            ...
                            var t = s.parentNode;
                            if (!t)return;
                            var u = h.getAttr(s, 'href') || window.location.href, v = new k(l.resolve('m'));
                    ...
                    setTimeout(function () {
                        ...
                        ES(ES('Array', 'from', false, fb_fif_window.document.getElementsByTagName('script')), 'forEach', true, function (x) {
                            if (x.src) {
                                ...
                                if (y) {
                                    var z = p.decode(y[2]);
                                    for (var aa in z)if (Object.prototype.hasOwnProperty.call(z, aa)) {
                                        var ba = z[aa];
                                        if (ba == '0')z[aa] = 0;
                                    }
                                    v(z);
                ...
                __d('legacy:fb.ua', ['FB', 'sdk.UA'], (function a(b, c, d, e, f, g, h, i) {
                    h.provide('UA', {nativeApp: i.nativeApp});
                }), 3);
                ...
                __d('IframePlugin', ['sdk.Auth', 'sdk.DOM', 'sdk.Event', 'Log', 'ObservableMixin', 'sdk.PlatformVersioning', 'QueryString', 'sdk.Runtime', 'Type', 'sdk.UA', 'sdk.URI', 'UrlMap', 'sdk.XD', 'sdk.createIframe', 'sdk.feature', 'guid', 'resolveURI'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x) {
                    ...
                    var ga = p.extend({
                        constructor: function ha(ia, ja, ka, la) {
                            ...
                            var na = s.resolve('www', true) + '/plugins/' + ka + '.php?', oa = {};
                ...
                __d('PluginTags', [], (function a(b, c, d, e, f, g) {
                    var h = {
                        ...
                        create_event_button: {},
                        follow: {href: 'url', layout: 'string', show_faces: 'bool', size: 'string'},
                        like: {
                            href: 'url',
                            layout: 'string',
                            show_faces: 'bool',
                        ...
                        messengerpreconfirmation: {messenger_app_id: 'string', page_id: 'string'},
                        messengeraccountconfirmation: {messenger_app_id: 'string', page_id: 'string', state: 'string'},
                        messengerbusinesslink: {messenger_app_id: 'string', page_id: 'string', state: 'string'},
                        messengertoggle: {
                            messenger_app_id: 'string',
                            page_id: 'string',
                            token: 'string',
                ...
                __d('sdk.XFBML.IframeWidget', ['sdk.Arbiter', 'sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Event', 'sdk.XFBML.Element', 'guid', 'insertIframe', 'QueryString', 'sdk.Runtime', 'sdk.ui', 'UrlMap', 'sdk.XD'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
                    var u = m.extend({
                        ...
                        process: function y(z) {
                            ...
                            var aa = this.getSize() || {}, ba = this.getFullyQualifiedURL();
                        ...
                        _updateIframeZIndex: function y() {
                            var z = this.dom.getElementsByTagName('span')[0], aa = this.getIframeNode(), ba = aa.style.height === z.style.height && aa.style.width === z.style.width, ca = ba ? 'removeCss' : 'addCss';
                            k[ca](aa, 'fb_iframe_widget_lift');
                        },
                        _repositionIframe: function y(z) {
                            var aa = this.getIframeNode(), ba = parseInt(k.getStyle(aa, 'width'), 10), ca = k.getPosition(aa).x, da = k.getViewportInfo().width, ea = parseInt(z.width, 10);
                            if (ca + ea > da && ca > ea) {
                        ...
                        _getURL: function y() {
                            var z = this.getDefaultWebDomain(), aa = '';
                ...
                __d('sdk.XFBML.Quote', ['sdk.DOM', 'DOMEventListener', 'IframePlugin', 'UnicodeUtils', 'sdk.UA', 'sdk.XD', 'containsNode', 'sdk.feature'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
                    ...
                    function y(da) {
                        var ea = da.getRangeAt(0), fa = ea.startContainer;
                    ...
                    function z(da) {
                        ...
                        if (fa) {
                            var ga = false;
                            for (var ha = 0; ha < fa; ha++)if (n(u[ha], ea.focusNode)) {
                                ga = true;
                                break;
                            }
                            if (!ga)return;
                    ...
                    function aa(da) {
                        var ea = w && w.offsetWidth, fa = ea ? w.offsetHeight : r, ga = ea ? w.offsetWidth : q, ha = da.getRangeAt(0), ia = document.createElement('span'), ja = document.createElement('span'), ka = document.createRange();
                        ka.setStart(ha.startContainer, ha.startOffset);
                        ka.insertNode(ia);
                        var la = document.createRange();
                        la.setStart(ha.endContainer, ha.endOffset);
                        la.insertNode(ja);
                        var ma = ia.offsetTop - fa, na = ia.offsetLeft + (ja.offsetLeft - ia.offsetLeft) / 2 - ga / 2;
                    ...
                    var q = void 0, r = l.extend({
                        constructor: function s(t, u, v, w) {
                            ...
                            this.subscribe('xd.savePluginGetBlankIframe', ES(function (y) {
                                var z = void 0, aa = void 0, ba = void 0, ca = function ha(ia) {
                ...
                __d('legacy:fb.xfbml', ['Assert', 'sdk.Event', 'FB', 'IframePlugin', 'PluginConfig', 'PluginTags', 'XFBML', 'sdk.domReady', 'sdk.feature', 'wrapFunction', 'sdk.XFBML.Comments', 'sdk.XFBML.CommentsCount', 'sdk.XFBML.LoginButton', 'sdk.XFBML.Name', 'sdk.XFBML.Quote', 'sdk.XFBML.Save', 'sdk.XFBML.ShareButton', 'sdk.XFBML.Video'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q) {
                    ...
                    ES(ES('Object', 'keys', false, m), 'forEach', true, function (t) {
                        ...
                        n.registerTag({xmlns: 'fb', localName: t.replace(/_/g, '-'), ctor: k.withParams(m[t], l[t])});
                    });
                    ES(ES('Object', 'keys', false, r), 'forEach', true, function (t) {
                        if (ES(s, 'indexOf', true, t) !== -1)return;
                        n.registerTag({xmlns: 'fb', localName: t.replace(/_/g, '-'), ctor: r[t]});
                    });
                    j.provide('XFBML', {
                        parse: function t(u) {
                    ...
                    i.subscribe('init:post', function (t) {
                        if (t.xfbml)setTimeout(q(ES(o, 'bind', true, null, n.parse), 'entry', 'init:post:xfbml.parse'), 0);
                    });
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2950535","namespace":"FB","message":"' + e.message + '"}}');
}
